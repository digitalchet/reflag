(() => {
  ...
  const REGION_NAMES = { AC: 'Ascension Island', CP: 'Clipperton Island', CQ: 'Sark', DG: 'Diego Garcia', EA: 'Ceuta & Melilla', EU: 'European Union', IC: 'Canary Islands', TA: 'Tristan da Cunha', UN: 'United Nations', XK: 'Kosovo' };
